...
sys.path.append("/home/filament/fujimoto/Cygnus-X_CAE/Cygnus-X_cloud/models")


def parse_args():
    parser = argparse.ArgumentParser(description="PyTorch Implementation of CAE")
    parser.add_argument(
        "--training_validation_path", metavar="DIR", help="training_validation_path", default="/home/filament/fujimoto/Cygnus-X_CAE/data/zroing_resize_data/resize_data/condition_match/vflip/CygnusX_cut_truncation_3size_resize_to_mode_percentile_100x100.npy"
    )
